...
The reusable engine acceptance path and the Era 0–3 research-preview implementations are complete. This authorizes explicitly labeled public previews, not promotion of the records to `published`: all four eras still require human review of their claim-level Chronicle citations, original summaries, interpretive visuals, stories, and causal chains. Later eras remain research scaffolds, and production-scale label density remains a future measurement gate.
