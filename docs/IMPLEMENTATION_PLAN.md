...
- Era 3, **Rise of the Ancient Civilizations**, now has a source-linked public research preview with three political time states over one inherited primordial landmass, nine events, a four-phase troll–aqir conflict dossier, nine new subjects plus an expanded aqir record, an explicit causal handoff to the War of the Ancients, and an unnumbered twelve-node guide. Key troll, aqir, mogu, pandaren, dark troll, kaldorei, and Azshara beats have deliberate clickable representation; broad influence remains visibly inferred rather than presented as surveyed borders. Human source, chronology, cartography, interpretation, and visual review still gates promotion.
...
The reusable engine acceptance path and the Era 0–6 research-preview implementations are complete. This authorizes explicitly labeled public previews, not promotion of the records to `published`: all seven eras still require human review of their claim-level Chronicle citations, original summaries, interpretive visuals, stories, and causal chains. Later eras remain research scaffolds, and production-scale label density remains a future measurement gate.
